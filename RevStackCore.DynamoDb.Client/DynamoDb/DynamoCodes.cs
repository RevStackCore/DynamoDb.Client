...
namespace RevStackCore.DynamoDb.Client
{
    ...
    public class GlobalSecondaryIndexHashKeyAttribute : AttributeBase
    {
        public GlobalSecondaryIndexHashKeyAttribute()
        {
        }
        public GlobalSecondaryIndexHashKeyAttribute(string rangeKey)
        {
            RangeKey = rangeKey;
        }
